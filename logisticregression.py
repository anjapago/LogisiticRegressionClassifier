...
def logistic_regression(data = 'classify_d5_k3_saved1.mat', learning_rate = 0.0001, num_steps = 50000):
	...
	# gradient descent:
	print("Running gradient descent, log-likelihoods:")
...
try:
	print("running logisitic regression on:")
	print(sys.argv[1])
	params = logistic_regression(data = sys.argv[1])
	print("Testing on test data...")
	accuracy = test(params, data = sys.argv[1])
	print("the accuracy is:")
	print(accuracy)

except Exception as e:
	print("Please use a dataset in format of: 'classify_d5_k3_saved1.mat'")
	print("running on 'classify_d5_k3_saved1.mat' as an example instead")
